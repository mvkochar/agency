    ...
    <footer className='footer'>
      <div className="d-f jc-sb">
        ...
        <div>
          ...
          <ul className="footer-list">
            <li className="text"><a href="">Design</a></li>
            <li className="text"><a href="">Development</a></li>
            <li className="text"><a href="">Marketing</a></li>
            <li className="text"><a href="">See More</a></li>
          </ul>
        </div>
      ...
      <div className="footer-info d-f jc-sb">
        <p className="footer-copyright">Copyright © 2022 Laaqiq. All Rights Reserved.</p>
        <div className="footer-links d-f">
